    ...
    (<CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
        <div className="relative w-full grid grid-cols-1 grid-rows-1">
          ...
          Up-Coming Events
            ...
            <div
              className={cn(
                "flex flex-row justify-start gap-4 lg:pl-32 sm:pl-4",
                "max-w-7xl mx-auto"
              )}>
...
export const Card = ({
  ...
  return (<>
    ...
    <motion.button
      layoutId={layout ? `card-${card.title}` : undefined}
      onClick={handleOpen}
      className="rounded-3xl bg-gray-100 dark:bg-neutral-900 h-80 w-56 md:h-[20rem] md:w-80 overflow-hidden flex flex-col items-start justify-start relative z-10">
      <div
